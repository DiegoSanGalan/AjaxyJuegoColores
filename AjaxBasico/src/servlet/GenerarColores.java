...
public class GenerarColores extends HttpServlet {
	...
	public String[] respuesta = new String [] {"Enhorabuena campeón", "Perfecto", "De p.m.", "Sigue así"};
    public String[] colores = new String [] {"red","blue","green","black","yellow","lime","fuchsia","orange","silver","navy"};
    ...
    static public Integer contsilver = 2;
    static public Integer contnavy = 2;
    /**
	...
	private void generarColores(HttpServletRequest request,
		...
		for (int i=0;i<numCeldas;i++) // para generar el xml con distintos colores
			...
			
		{
			...
			{
				color = colores [new Random().nextInt(colores.length)]; // genero uno aleatorio
	...
	private boolean comprobarColor(String color) {
		...
		// compruebo el color y voy descontando del total de 4 que puedo de cada uno
					switch (color) {
					case "red": if (contred == 0)
									{
